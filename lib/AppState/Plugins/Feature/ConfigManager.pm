...
has _current_config_object =>
    ...
    , handles           =>
      ...
      , qw( C_CFF_CONFIGDIR C_CFF_WORKDIR C_CFF_FILEPATH
        ...
        #
      , qw( C_DOC_SELOUTRANGE C_DOC_DOCRETRIEVED
            C_DOC_NODOCUMENTS C_DOC_NOHASHREF
            C_DOC_EVALERROR C_DOC_NOVALUE
            C_DOC_NOKEY
          )

        # From ConfigIO via ConfigFile
        #
      , qw( C_CIO_CFGREAD C_CIO_CFGWRITTEN C_CIO_CFGNOTREAD
