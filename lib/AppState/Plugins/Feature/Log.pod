...
=head1 PROGRAM CODES
  ...
  ROOT_FILE            The name used to set/get the root logger for file logging
                       from Log::Log4perl.
  ROOT_STDERR          The name used to set/get the root logger from
                       Log::Log4perl.to send messages to stderr.
  ROOT_EMAIL           The name used to set/get the root logger for email
                       logging from Log::Log4perl.
