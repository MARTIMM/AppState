...
# Error codes
#
def_sts( 'C_CFM_CFGSELECTED'   , 'M_TRACE', 'Config %s selected');
def_sts( 'C_CFM_CFGNOTEXIST'   , 'M_WARN',  'Config %s not existent');
def_sts( 'C_CFM_CFGADDED'      , 'M_TRACE', 'Config %s added');
def_sts( 'C_CFM_CFGEXISTS'     , 'M_WARN',  'Config %s already exists');
def_sts( 'C_CFM_CFGMODIFIED'   , 'M_TRACE', 'Config %s modified and selected');
def_sts( 'C_CFM_CFGDROPPED'    , 'M_TRACE', 'Config %s dropped');
def_sts( 'C_CFM_CFGSELDEFAULT' , 'M_TRACE', 'Current config set to %s');
def_sts( 'C_CFM_CFGFLREMOVED'  , 'M_TRACE', 'Config %s removed');
